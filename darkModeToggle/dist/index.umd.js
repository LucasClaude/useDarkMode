(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@babel/runtime/helpers/slicedToArray'), require('react'), require('react-responsive'), require('clsx')) :
  typeof define === 'function' && define.amd ? define(['exports', '@babel/runtime/helpers/slicedToArray', 'react', 'react-responsive', 'clsx'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["use-dark-mode-toggle"] = {}, global._slicedToArray, global.React, global.reactResponsive, global.clsx));
})(this, (function (exports, _slicedToArray, React, reactResponsive, clsx) { 'use strict';
  ...
  var useDarkModeToggle = function useDarkModeToggle() {
    ...
    var _useState = React.useState((_localStorage = localStorage) === null || _localStorage === void 0 ? void 0 : _localStorage.getItem("currentTheme")),
        _useState2 = _slicedToArray__default["default"](_useState, 2),
        theme = _useState2[0],
        setActiveTheme = _useState2[1];

    var isDark = theme ? theme === "dark" ? true : false : undefined;
    var systemPrefersDark = reactResponsive.useMediaQuery({
    ...
    var returnToggle = function returnToggle() {
      return /*#__PURE__*/React__default["default"].createElement(ToggleButton, {
        onClick: setTheme,
  ...
  var ToggleButton = function ToggleButton(_ref) {
    ...
    var linkColor = React.useMemo(function () {
    ...
    return /*#__PURE__*/React__default["default"].createElement("button", {
      ...
      onClick: onClick
    }, /*#__PURE__*/React__default["default"].createElement(SvgToggleButton, {
      fill: secondaryColor,
      className: clsx__default["default"]("toggle-button-toggle", {
        "toggle-button-toggle-dark": isDark
      }, {
        "toggle-button-toggle-light": !isDark
      })
    }), /*#__PURE__*/React__default["default"].createElement(SvgToggleBar, {
      fill: linkColor,
      className: "toggle-button-bar"
    }), !isDark && /*#__PURE__*/React__default["default"].createElement(SvgMoon, {
      fill: secondaryColor,
      className: "toggle-button-moon"
    }), isDark && /*#__PURE__*/React__default["default"].createElement(SvgSun, {
      fill: secondaryColor,
      className: "toggle-button-sun"
    }));
  };

  exports.useDarkModeToggle = useDarkModeToggle;
